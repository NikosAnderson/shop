...
for ($i = 0; $i < 50; $i++) {
	...
	$product_category = rand(1, 4);
	$product_name = substr($product_description, 0, $first_point_pos - 1);
...
//exit(Utils::debug($products));

$query = Db::getInstance()->prepare('INSERT INTO product (category, name, description, price, picture, rating, date) VALUES (:category, :name, :description, :price, :picture, :rating, :date)');
...
echo $count.' produit(s) insérée(s)';